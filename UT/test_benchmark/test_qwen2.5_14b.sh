...
BASE_ROOT=../../benchmark/qwen2.5/14B/
cd $BASE_ROOT
...
if [ $RUN_TILEARN -eq 1 ]; then
    ...
    if [ "$GPU_MEM" = "40G" ]; then
        ...
        export LF_UT_DSYAML_PATH_PREFIX=${LF_UT_DSYAML_PATH_PREFIX:-"ds_z2_config.json ||| ds_z2_config.json"}
    ...
    if [ "$GPU_MEM" = "40G" ]; then
        ...
        export LF_UT_DSYAML_TARGET=${LF_UT_DSYAML_TARGET:-"../../utils/ds_config/ds_z2_config.json"}
